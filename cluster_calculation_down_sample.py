...
def generate_kmeans_clusters(start_subject, end_subject,
    ...
    for i in range(start_subject, end_subject + 1):
        ...
        datafile_645_down_sample = f"{dfc_645_down_sample_mds_path}/subject_{i}.json"
        datafile_645 = f"{dfc_645_mds_path}/subject_{i}.json"
        dataset_2500 = get_dataset(datafile_2500)
        dataset_645_down_sample = get_dataset(datafile_645_down_sample)
        ...
        cluster_info[i] = [
            n_clusters_2500, n_clusters_645_down_sample, n_clusters_645
        ]
...
def show_clustering_results(cluster_summary,
    ...
    if csv_file_path:
        with open(csv_file_path, 'w', newline='') as csvfile:
            column_names = ['Subject', 'DFC 2500', 'DFC 645 DS', 'DFC 645']
            csv_data = []
            for subject in cluster_summary:
                subject_data = {}
...
def main():
    ...
    dfc_645_ds_mds = "../dfc_645_down_subjects_mds_ws"
    dfc_645_mds = "../dfc_645_subjects_mds_ws"
    output_dir = "../clusters_kmeans_down"

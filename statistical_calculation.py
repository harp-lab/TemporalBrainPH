...
def draw_line_chart(x, y, y_limit_bottom=None, y_limit_top=None,
    ...
    if legend:
        ...
        # plt.legend(loc='upper right', bbox_to_anchor = (1.05, 0.6))
    if x_axis_label:
...
def main(data):
    ...
    with open(data) as fp:
        ...
        output_filename = "TDA_clusters.png"
        if "non_tda" in data:
            output_filename = "Non_TDA_clusters.png"
        ...
        draw_line_chart(subject_numbers, rows,
                        ...
                        legend=header, output_filename=output_filename)
